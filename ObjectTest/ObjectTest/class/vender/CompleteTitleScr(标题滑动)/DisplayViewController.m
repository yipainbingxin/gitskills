...
- (void)setUpTitleGradient:(void(^)(TitleColorGradientStyle *titleColorGradientStyle,UIColor **norColor,UIColor **selColor))titleGradientBlock;
{
    ...
    if (_titleColorGradientStyle == TitleColorGradientStyleFill && _titleWidth > 0) {
...
- (void)viewWillAppear:(BOOL)animated
{
    ...
    if (_isInitial == NO) {
        ...
        if (_titleColorGradientStyle == TitleColorGradientStyleFill || _titleWidth == 0) { // 填充样式才需要这样
...
- (void)setUpAllTitle
{
    ...
    for (int i = 0; i < count; i++) {
        ...
        if (_titleColorGradientStyle == TitleColorGradientStyleFill || _titleWidth == 0) { // 填充样式才需要
...
- (void)setUpTitleColorGradientWithOffset:(CGFloat)offsetX rightLabel:(DisplayTitleLabel *)rightLabel leftLabel:(DisplayTitleLabel *)leftLabel
{
    ...
    // RGB渐变
    if (_titleColorGradientStyle == TitleColorGradientStyleRGB) {
    ...
    // 填充渐变
    if (_titleColorGradientStyle == TitleColorGradientStyleFill) {
