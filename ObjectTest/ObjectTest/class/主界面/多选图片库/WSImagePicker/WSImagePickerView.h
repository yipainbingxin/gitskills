...
@class WSImagePickerView;

@protocol WSImagePickerViewDelegate <NSObject>

@optional
- (void)orderView:(WSImagePickerView *)views orderArray:(NSArray *)array;
...
@property (assign, nonatomic) id<WSImagePickerViewDelegate>delegate;
